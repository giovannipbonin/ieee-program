...
Here we will start diving in depth on algorithms and data structures previously touched, and explore more domains of applications where they are useful and review and do exercises
